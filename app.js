...
p.fish.forEach((f,j)=>{
if(j<3){
lh+='<div class="rd-f"><span>★'+(j+1)+' '+f.fish+' '+f.size+'cm</span><span>'+f.time+'</span></div>';
}else{
lh+='<div class="rd-f" style="color:#bbb"><span>　　'+f.fish+' '+f.size+'cm</span><span>'+f.time+'</span></div>';
}
});
lh+='</div>';
});
